...
| **memory** | 1.0+ | [AgentMemory](https://github.com/YintaTriss/AgentMemory) | 记忆中心 | 偏好、上下文、学习定位、智能遗忘 |
| **search** | 1.0+ | [AgentSearch](https://github.com/YintaTriss/AgentSearch) | 信息获取 | Web搜索、本地检索、爬虫、过滤、排序 |
